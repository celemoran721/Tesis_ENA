...
--------------------------------------------------------------------------------------------------------------
                     <?Php $verifica = NotaTareaData::getAllByNota($info->id);
					   ...
					   <?php } } else {
                        ...
                        <div class="row">
						<label for="inputEmail1" class="col-lg-1 control-label">ID tarea</label>
							<div class="col-md-1">
						<input type="text" name="id_ta" required class="form-control" id="id_ta" value="<?php echo $m->id;?>"> <placeholder="">
							</div>
						</div>							
								...
								<div class="form-group">
								<div class="col-lg-offset-8 col-lg-12">
								<input type="hidden" name="id_as" value="<?php echo $a->id;?>">
								<center><button type="submit" class="btn btn-primary">Almacenar Nota</button></center>
								</div>
								</div>
